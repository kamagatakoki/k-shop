		...
		<div class="container">
			<div class="row">
				...
				<div class="container">
					...
					<form:form modelAttribute="genreMdForm" action="list" class="form-horizontal" method="post">
				...
				<!-- エラーメッセージ(削除チェック用) -->
				<spring:hasBindErrors name="genreMdForm">
									...
									<tbody>
										...
										<c:forEach items="${items}" var="item">
											<tr>
												...
												<td>
													<form:form action="/views/maintenance/genremd/list" class="form-horizontal" method="post">
														<button class="btn btn-border-d btn-circle btn-sm" type="submit" name="edit" ><i class="fa fa-cog fa-spin"></i> 編集</button>
														<input type="hidden" name="crud" value="update" />
														<input type="hidden" name="genreMdCd" value="${item.genreMdCd}" />
													</form:form>
												</td>
