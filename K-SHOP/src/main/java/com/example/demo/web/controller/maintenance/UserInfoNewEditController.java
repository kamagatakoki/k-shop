...
import com.example.demo.service.maintenance.UserInfoService;
...
public class UserInfoNewEditController {
	...
	String regsit(@Validated({ Insert.class, Default.class }) UserInfoForm userInfoForm,
			BindingResult bindingResult) {

		// バリデーションエラーがあれば中断
		if (bindingResult.hasErrors()) {
			return "maintenance/userinfo_newedit";
		}
