...
public interface GenreSmMapper {
	 ...
	 * @mbg.generated
	 */
	long countByCriteria(GenreSmCriteria example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table GENRE_SM
	 * @mbg.generated
	 */
	int deleteByCriteria(GenreSmCriteria example);
	 ...
	 * @mbg.generated
	 */
	List<GenreSmEntity> selectByCriteriaWithRowbounds(GenreSmCriteria example, RowBounds rowBounds);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table GENRE_SM
	 * @mbg.generated
	 */
	List<GenreSmEntity> selectByCriteria(GenreSmCriteria example);
	 ...
	 * @mbg.generated
	 */
	int updateByCriteriaSelective(@Param("record") GenreSmEntity record, @Param("example") GenreSmCriteria example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table GENRE_SM
	 * @mbg.generated
	 */
	int updateByCriteria(@Param("record") GenreSmEntity record, @Param("example") GenreSmCriteria example);
	 ...
	 */
	List<GenreSmEntity> selectGenreLgMdSmByCriteria(GenreSmCriteria criteria);
