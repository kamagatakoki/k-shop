 ...
 * @author ITG
 */
public class DFacilityBathDivRentalOutsideSpa {

    /** 風呂区分 : 貸切露天風呂 */
    private static final Integer BATH_DIV = BathDiv.RENTAL_OUTSIDE_SPA.code();
     ...
     * コンストラクタ
     */
    public DFacilityBathDivRentalOutsideSpa() {
        super();
